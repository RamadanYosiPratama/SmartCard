      ...
      <div class="box">        
        <div class="box-body">
			...
			<form action="<?php echo $action; ?>" method="post">
			 ...
			 <div class="form-group">
				<label for="char">Nomor Mahasiswa <?php echo form_error('nis') ?></label>
				<input type="text" class="form-control" name="nis" id="nis" placeholder="Nis" value="<?php echo $nis; ?>" readonly />
			 </div>
			 <div class="form-group">
				<label for="int">Matakuliah <?php echo form_error('kode_matapelajaran') ?></label>
				    <?php $query = $this->db->query('SELECT kode_matapelajaran,nama_matapelajaran FROM matapelajaran');
