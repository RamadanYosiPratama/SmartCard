...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="admin" class="logo">
      ...
      <span class="logo-mini"><b>Smart</b>Course</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SmartCard</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">          
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets/img/x.jpg') ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $username; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url('assets/img/x.jpg') ?>" class="img-circle" alt="User Image">
    ...
    <section class="content">
      ...
      <div class="box">               
			  ...
			  <div class="row">
				<div class="col-sm-4 col-md-2">
				  ...
				  <div class="color-palette-set">
					<a href="<?php echo site_url('siswa') ?>"><center><i class="fa fa-user" style="font-size:48px;color:#3c8dbc"></i><center></a>					
				  </div>
				</div>
				<!-- /.col -->
				<div class="col-sm-4 col-md-2">
        ...
        <div class="box-footer">
         <center>SmartCard<a href="http://www.langitinspirasi.co.id"><strong>Course</strong></a> - 2019</center>
        </div>
        <!-- /.box-footer-->
      </div>
      <!-- /.box -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://adminlte.io">Ramadaan Studio</a>.</strong> All rights
    reserved.
  </footer>
